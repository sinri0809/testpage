const IconClose = () => {
  return <svg className="icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M12.0065 9.63633L5.36378 3L3 5.3615L9.64274 11.9978L3.13626 18.498L5.46063 20.8202L11.9671 14.32L18.7585 21.1048L21.1223 18.7433L14.3309 11.9585L20.9564 5.33933L18.632 3.01721L12.0065 9.63633Z" fill="#555555" />
  </svg>
}
