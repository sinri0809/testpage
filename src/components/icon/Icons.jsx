...
const IconMore = () => {
  return <svg className="icon" width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M17 30.0667C24.2165 30.0667 30.0667 24.2165 30.0667 17C30.0667 9.7835 24.2165 3.93335 17 3.93335C9.7835 3.93335 3.93335 9.7835 3.93335 17C3.93335 24.2165 9.7835 30.0667 17 30.0667Z" stroke="black" stroke-width="2" />
    <path d="M14.6667 11.8667L20.2667 17L14.6667 22.1334" stroke="black" stroke-width="2" />
  </svg>
